        ...
        if(forma_pago_orden == data.Des_FormaPago+'-'+data.Nom_FormaPago){
            ...
            if(!dataFormaPago.hasOwnProperty(forma_pago_orden)){
                dataFormaPago[forma_pago_orden]={
                    "html": 
                            '<tr class="row">'+
                                '<td style="width:auto;font-weight: bold;font-size: 12px">'+forma_pago_orden+'</td>'+
                                '<td style="width:auto"></td>'+
                                '<td style="width:auto;font-size: 12px">'+data.Movimiento+'</td>'+
                                '<td style="width:auto;font-weight: bold;font-size: 12px"></td>'+
                                '<td style="width:auto;font-size: 10px">'+(data.Fecha?data.Fecha.toString().split('T')[0]:'')+'</td>'+ 
                                '<td style="width:auto;font-weight: bold;;font-size: 12px;text-align:right">'+data.MontoMovimiento+'</td>'+
                            '</tr>'+
                            '<tr class="row">'+
