...
function recorrerArreglo(detalles) {  
            ...
            dataDocumento[keyD]['formas_pago'][keyFP].forEach(function(dataHtml,index){
                ...
                if(index==(dataDocumento[keyD]['formas_pago'][keyFP].length-1)){
                      html_forma_pago = html_forma_pago +   '<tr class="row">'+ 
                                                                ...
                                                                '<td class="tablaDetalleAlert">'+parseFloat(suma_total_pagar).toFixed(2)+'</td>'+
                                                                '<td class="tablaDetalleAlert">'+parseFloat(suma_total_amortizado).toFixed(2)+'</td>'+
                                                                '<td class="tablaDetalleAlert">'+parseFloat(suma_total_falta_pagar).toFixed(2)+'</td>'+
                                                            '</tr>'
    ...
    html_general = html_general+'<tr class="row">'+ 
                ...
                '<td></td>'+
                '<td></td>'+
                '<td class="tablaDetalleAlert">TOTAL GENERAL </td>'+
                '<td class="tablaDetalleAlert">'+parseFloat(total_suma_total_pagar).toFixed(2)+'</td>'+
                '<td class="tablaDetalleAlert">'+parseFloat(total_suma_total_amortizado).toFixed(2)+'</td>'+
                '<td class="tablaDetalleAlert">'+parseFloat(total_suma_total_falta_pagar).toFixed(2)+'</td>'+
                '</tr>'
