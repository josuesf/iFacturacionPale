        ...
        if(!dataProductos.hasOwnProperty(cod_producto_orden)){
            dataProductos[cod_producto_orden]={
                "html": '<tr class="row">'+
                            ...
                            '<td style="width:auto" colspan="3">'+data.Cod_Producto+'</td>'+
                        ...
                        '</tr>'+
                        '<tr class="row">'+
                            '<td style="width:auto;font-weight: bold" colspan="2">PRODUCTO : </td>'+
                            '<td style="width:auto" colspan="5">'+data.Nom_Producto+'</td>'+
                            '<td style="width:auto;font-weight: bold" colspan="2">UNIDAD DE MEDIDA</td>'+
                            '<td style="width:auto" colspan="3">'+data.UnidadMedida+'</td>'+
                        '</tr>'+
