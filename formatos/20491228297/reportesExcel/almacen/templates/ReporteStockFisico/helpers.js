...
function recorrerArreglo(detalles) {  
            ...
            dataDocumento[keyD]['clase_almacen'][keyFP].forEach(function(dataHtml,index){
                ...
                if(index==(dataDocumento[keyD]['clase_almacen'][keyFP].length-1)){
                     html_movimientos_caja = html_movimientos_caja +   '<tr class="row">'+ 
                                                                ...
                                                                '<td class="tablaDetalleSusses"></td>'+
                                                                '<td class="tablaDetalleSusses">'+parseFloat(suma_subtotal_stock_actual).toFixed(2)+'</td>'+
    ...
    html_general = html_general+'<tr class="row">'+
                                ...
                                '<td class="tablaDetallePrimary textoNegrita" colspan="2">'+parseFloat(suma_total_stock_actual).toFixed(2)+'</td>'+
                                '</tr>'+
                                '<tr class="row">'+ 
                                '<td colspan="2"></td>'+
                                '<td class="tablaDetallePrimary textoWarning textoNegrita" colspan="4">TOTAL GENERAL STOCK ACTUAL : </td>'+
