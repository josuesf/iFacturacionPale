...
function recorrerArreglo(detalles) {  
            ...
            dataDocumento[keyD]['clase_almacen'][keyFP].forEach(function(dataHtml,index){
                ...
                if(index==(dataDocumento[keyD]['clase_almacen'][keyFP].length-1)){
                     html_movimientos_caja = html_movimientos_caja +   '<tr class="row">'+ 
                                                                ...
                                                                '<td  ></td>'+
                                                                '<td class="tablaDetalleAlert">'+parseFloat(suma_subtotal_stock_cantidad).toFixed(2)+'</td>'+
                                                                '<td class="tablaDetalleAlert">'+parseFloat(suma_subtotal_stock_compra).toFixed(2)+'</td>'+
                                                                '<td class="tablaDetalleAlert">'+parseFloat(suma_subtotal_stock_valorizado).toFixed(2)+'</td>'+
                                                            '</tr>'+
    ...
    html_general = html_general+'<tr class="row">'+
                                ...
                                '<td class="tablaDetalleAlert" colspan="2">'+parseFloat(suma_total_stock_cantidad).toFixed(2)+'</td>'+
                                '</tr>'+
                                '<tr class="row">'+ 
                                '<td colspan="2"></td>'+
                                '<td class="tablaDetalleAlert" colspan="4">TOTAL GENERAL PRECIO DE COPMPRA : </td>'+
                                '<td class="tablaDetalleAlert" colspan="2">'+parseFloat(suma_total_stock_compra).toFixed(2)+'</td>'+
                                '</tr>'+
                                '<tr class="row">'+ 
                                '<td colspan="2"></td>'+
                                '<td class="tablaDetalleAlert" colspan="4">TOTAL GENERAL VALORIZADO : </td>'+
                                '<td class="tablaDetalleAlert" colspan="2">'+parseFloat(suma_total_stock_valorizado).toFixed(2)+'</td>'+
                                '</tr>'
