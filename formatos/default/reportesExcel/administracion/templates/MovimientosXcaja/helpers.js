...
function recorrerArreglo(detalles) {  
            ...
            dataDocumento[keyD]['clase_concepto'][keyFP].forEach(function(dataHtml,index){
                ...
                if(index==(dataDocumento[keyD]['clase_concepto'][keyFP].length-1)){
                     html_movimientos_caja = html_movimientos_caja +   '<tr class="row">'+ 
                                                                ...
                                                                '<td class="tablaDetalleSusses">'+parseFloat(suma_subtotal_soles_ingreso).toFixed(2)+'</td>'+
                                                           
                                                                '<td class="tablaDetalleSusses">'+parseFloat(suma_subtotal_soles_egreso).toFixed(2)+'</td>'+
                                                           
                                                                '<td class="tablaDetalleSusses">'+parseFloat(suma_subtotal_dolares_ingreso).toFixed(2)+'</td>'+
                                                             
                                                                '<td class="tablaDetalleSusses">'+parseFloat(suma_subtotal_dolares_egreso).toFixed(2)+'</td>'+
                                                            '</tr>'+
    ...
    html_general = html_general+'<tr class="row">'+
                                ...
                                '<tr class="row">'+ 
                                '<td colspan="2"></td>'+
                                '<td class="tablaDetallePrimary textoWarning textoNegrita" colspan="4">TOTAL GENERAL INGRESOS EN SOLES : </td>'+
                                '<td class="tablaDetallePrimary textoNegrita" colspan="2">'+parseFloat(suma_total_subtotal_soles_i).toFixed(2)+'</td>'+
                                '</tr>'+
                                '<tr class="row">'+ 
                                '<td colspan="2"></td>'+
                                '<td class="tablaDetallePrimary textoWarning textoNegrita" colspan="4">TOTAL GENERAL EGRESOS EN SOLES : </td>'+
                                '<td class="tablaDetallePrimary textoNegrita" colspan="2">'+parseFloat(suma_total_subtotal_soles_e).toFixed(2)+'</td>'+
                                '</tr>'+
                                '<tr class="row">'+ 
                                '<td colspan="2"></td>'+
                                '<td class="tablaDetallePrimary textoWarning textoNegrita" colspan="4">TOTAL GENERAL INGRESOS EN DOLARES : </td>'+
                                '<td class="tablaDetallePrimary textoNegrita" colspan="2">'+parseFloat(suma_total_subtotal_dolares_i).toFixed(2)+'</td>'+
                                '</tr>'+
                                '<tr class="row">'+ 
                                '<td colspan="2"></td>'+
                                '<td class="tablaDetallePrimary textoWarning textoNegrita" colspan="4">TOTAL GENERAL EGRESOS EN DOLARES : </td>'+
                                '<td class="tablaDetallePrimary textoNegrita" colspan="2">'+parseFloat(suma_total_subtotal_dolares_e).toFixed(2)+'</td>'+
                                '</tr>'
