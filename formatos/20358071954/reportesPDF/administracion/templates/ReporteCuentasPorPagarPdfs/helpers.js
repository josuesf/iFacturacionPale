            ...
            dataDocumento[keyD]['formas_pago'][keyFP].forEach(function(dataHtml,index){
                ...
                if(index==(dataDocumento[keyD]['formas_pago'][keyFP].length-1)){
                      html_forma_pago = html_forma_pago +   '<tr class="row">'+ 
                                                                ...
                                                                '<td></td>'+
                                                                '<td></td>'+
                                                                '<td class="tablaDetalleAlert" style="text-align:left">TOTAL DEUDA</td>'+
                                                                '<td class="tablaDetalleAlert"style="text-align:right">'+parseFloat(suma_cantidad).toFixed(2)+'</td>'+
                                                                '<td class="tablaDetalleAlert" style="text-align:right">'+parseFloat((suma_precio_promedio)/cantidad_items).toFixed(2)+'</td>'+
                                                                '<td class="tablaDetalleAlert"style="text-align:right">'+parseFloat(suma_subtotal).toFixed(2)+'</td>'+
                                                            '</tr>'
                  }
            })
