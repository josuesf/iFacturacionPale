...
jsreport = require('jsreport-core')(
  {
    ...
    extensions: {
        ...
        'fs-store': {
          ...
          dataDirectory: require('path').join(__dirname, 'formatos/default/reportesExcel/compras'),//almacena templates genericos para los reportes excel ventas
...
//Listen Server
var server = app.listen(9002, function (err) {
  if (err) return console.log('Hubo un error'), process.exit(1);
  console.log('Escuchando en el puerto 9002');
})
