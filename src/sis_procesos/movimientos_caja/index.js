                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="txtTitulo">Ingrese la justificacion del Extorno / Anulacion </h4>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                ...
                                <p id="txtDescripcion">Por ejemplo: Por error de ingreso</p>
...
function AceptarConfirmacion(){
    ...
    if(flagOpciones=="eliminar"){
        $("#txtTitulo").text("Ingrese una justificacion de eliminacion")
        $("#txtDescripcion").text("Por ejemplo : Por error de ingreso en monto") 
        $("#modal-justificacion").modal("show")
    }else{
        if(flagOpciones=="extornar"){
            $("#txtTitulo").text("Ingrese una justificacion del extorno / anulacion")
            $("#txtDescripcion").text("Por ejemplo : Por error de ingreso en") 
            $("#modal-justificacion").modal("show")
        }
    }
}
