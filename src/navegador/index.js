    ...
    <ul class="sidebar-menu" data-widget="tree"> 
            ...
            <li class="treeview active">
                ...
                <ul class="treeview-menu">
                    <li>
                        <a href="#" onclick=${() => ListarProductosServ(true)}><i class="fa fa-circle-o"></i> Productos y servicios</a>
                    </li>
                    <li>
                        <a href="#" onclick=${() => ListarClientes(true)}><i class="fa fa-circle-o"></i> Cliente/Proveedor</a>
                    </li>
                </ul>
            </li>
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li>
                        <a href="#" onclick=${() => ListarCuentasBancarias(true)}><i class="fa fa-circle-o"></i> Cuentas Bancarias</a>
                    </li>
                </ul>
            </li>
            <li class="treeview">
