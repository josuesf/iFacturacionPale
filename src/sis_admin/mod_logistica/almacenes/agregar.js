...
function Ver(_escritura, tipo_almacenes, almacen, cajas_almacen) {
    ...
    var tab = yo`
    <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false" id="id_2">Nuevo almacen<a style="padding-left: 10px;" class="btn" onclick=${()=>CerrarTab()}><i class="fa fa-close text-danger"></i></a></a></li>`
