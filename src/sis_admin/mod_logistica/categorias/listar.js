...
function Ver(categorias, paginas, pagina_actual, _escritura,tamanio_pagina){
    var tab = yo`
                            ...
                            <div class="form">
                                <div class="form-group floating-label">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-content">
                                            <select id="nro_registros_categorias" onchange=${()=>CambioTamanioPagina()} class="form-control input-sm">
...
function CambioTamanioPagina(){ 
    ListarCategorias(true,null,null,null,$("#nro_registros_categorias").val())
}
...
function ListarCategorias(escritura,NumeroPagina,ScripOrden,ScripWhere,TamanioPagina) {
    ...
    fetch(URL+'/categorias_api/get_categorias', parametros)
        ...
        .then(res => {
            if (res.respuesta == 'ok') {
                ...
                Ver(res.data.categorias, paginas,NumeroPagina||0, _escritura,TamanioPagina)
            }
            else
                Ver([])
            $('#main-contenido').waitMe('hide');
