...
module.exports = function NuevoPerfil(_escritura,modulos, perfil) {
    ...
    var el = yo`
    <div class="tab-pane" id="tab_crear_perfil_2">
    ...
    if($("#tab_crear_perfil_2").length){  

        $('#tab_crear_perfil_2').remove()
        $('#id_tab_crear_perfil_2').parents('li').remove()
