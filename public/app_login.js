...
function obtenerDatosSUNAT(ruc) {
    ...
    if (window.XMLHttpRequest) //Crear XHR
        xhr = new XMLHttpRequest();else if (window.ActiveXObject) xhr = new ActiveXObject("Microsoft.XMLHTTP");else return false;
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState == 4 && xhr.status == 200) {
            ...
            if (campos.length) {
                ...
                try {
                    for (var _iterator = campos[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        txt = _step.value;
            ...
            if (ok) existente.classList.add("ok");else existente.classList.remove("ok");
