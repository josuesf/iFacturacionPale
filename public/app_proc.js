...
},{"../navegador_procesos":345,"empty-element":330,"page":338,"title":339,"yo-yo":340}],344:[function(require,module,exports){
'use strict';
...
},{"./constantes_entorno/constantes":342,"./home_procesos":343,"./navegador_procesos":345,"babel-polyfill":1,"page":338}],345:[function(require,module,exports){
'use strict';

var _templateObject = _taggedTemplateLiteral(['\n<ul class="sidebar-menu" data-widget="tree">\n    <li class="header">Ventas</li>\n    <li class="treeview">\n        <a href="#"W>\n            <i class="fa fa-home"></i> <span>Movimientos de caja</span>\n            <span class="pull-right-container">\n            <i class="fa fa-angle-left pull-right"></i>\n            </span>\n        </a>\n        <ul class="treeview-menu">\n            <li class=""><a href="#" onclick=', '><i class="fa fa-circle-o"></i> Recibo de Ingresos</a></li>\n            <li class=""><a href="#" onclick=', '><i class="fa fa-circle-o"></i> Compra y Venta de Dolar</a></li>\n        </ul>\n    </li>\n    \n</ul>'], ['\n<ul class="sidebar-menu" data-widget="tree">\n    <li class="header">Ventas</li>\n    <li class="treeview">\n        <a href="#"W>\n            <i class="fa fa-home"></i> <span>Movimientos de caja</span>\n            <span class="pull-right-container">\n            <i class="fa fa-angle-left pull-right"></i>\n            </span>\n        </a>\n        <ul class="treeview-menu">\n            <li class=""><a href="#" onclick=', '><i class="fa fa-circle-o"></i> Recibo de Ingresos</a></li>\n            <li class=""><a href="#" onclick=', '><i class="fa fa-circle-o"></i> Compra y Venta de Dolar</a></li>\n        </ul>\n    </li>\n    \n</ul>']);

var _agregar = require('../sis_procesos/mod_ventas/mod_compra_venta_moneda_extranjera/agregar');
...
var el = yo(_templateObject, function () {
    ...
    return (0, _agregar.NuevoCompraVentaDolar)(true);
});
...
},{"../sis_procesos/mod_ventas/mod_compra_venta_moneda_extranjera/agregar":346,"empty-element":330,"yo-yo":340}],346:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.NuevoCompraVentaDolar = undefined;
...
function Ver(_escritura, Serie, variables) {
    ...
    }), Serie, Serie, variables.entidades_financieras.map(function (e) {
        return yo(_templateObject2, e.Cod_EntidadFinaciera, e.Nom_EntidadFinanciera);
    }));
...
function TraerCuentaBancariaEntidadFinanciera(_escritura, Serie, variables) {
    ...
    var parametros = {
        ...
        body: JSON.stringify({
            Cod_EntidadFinaciera: Cod_EntidadFinaciera
        })
    };
