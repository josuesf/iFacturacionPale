...
var _listar = require('../usuarios/listar');
...
module.exports = function NuevoUsuario(_escritura, _estados, _perfiles, usuario) {
    ...
    var el = yo(_templateObject, function () {
        return (0, _listar.Listar)(_escritura);
    }, usuario ? 'Editar' : 'Nuevo', function () {
        return (0, _listar.Listar)(_escritura);
    }, usuario ? yo(_templateObject2) : yo(_templateObject3), usuario ? usuario.Nick : '', preguntas_seguridad.map(function (e) {
        return yo(_templateObject4, e, usuario ? usuario.Pregunta == e ? 'selected' : '' : '', e);
    }), usuario ? usuario.Respuesta : '', _estados.map(function (e) {
        return yo(_templateObject4, e.Cod_Estado, usuario ? usuario.Cod_Estado == e.Cod_Estado ? 'selected' : '' : '', e.Nom_Estado);
    }), _perfiles.map(function (e) {
        return yo(_templateObject5, e.Cod_Perfil, usuario ? usuario.Cod_Perfil == e.Cod_Perfil ? 'selected' : '' : '', e.Des_Perfil);
    }), function () {
        return Guardar(_escritura, usuario);
    });
...
function Ver(usuarios, paginas, _escritura, _estados, _perfiles) {
    var el = yo(_templateObject3, _escritura ? yo(_templateObject4, function () {
        return NuevoUsuario(_escritura, _estados, _perfiles);
        ...
        return yo(_templateObject6, u.Cod_Usuarios, u.Pregunta, u.Cod_Perfil, u.Cod_Estado, _escritura ? yo(_templateObject7, function () {
            return NuevoUsuario(_escritura, _estados, _perfiles, u);
...
function EliminarUsuario(_escritura, usuario) {
    ...
    btnEliminar.addEventListener('click', function Eliminar(ev) {
        ...
        fetch('/usuarios_api/eliminar_usuario', parametros).then(function (req) {
            return req.json();
        }).then(function (res) {
