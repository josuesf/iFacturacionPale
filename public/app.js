...
var _templateObject = _taggedTemplateLiteral(['<div><button class="btn btn-xs btn-success">Editar</button>\n    <button class="btn btn-xs btn-danger">Borrar</button></div>'], ['<div><button class="btn btn-xs btn-success">Editar</button>\n    <button class="btn btn-xs btn-danger">Borrar</button></div>']),
    ...
    _templateObject7 = _taggedTemplateLiteral(['<button class="btn btn-xs btn-success" "><i class="fa fa-edit"></i></button>'], ['<button class="btn btn-xs btn-success" "><i class="fa fa-edit"></i></button>']),
    _templateObject8 = _taggedTemplateLiteral(['<button class="btn btn-xs btn-danger" data-toggle="modal" data-target="#modal-danger" ><i class="fa fa-trash"></i></button>'], ['<button class="btn btn-xs btn-danger" data-toggle="modal" data-target="#modal-danger" ><i class="fa fa-trash"></i></button>']),
...
function Ver(cajas, paginas, _escritura, _sucursales) {
    var el = yo(_templateObject3, _escritura ? yo(_templateObject4, function () {
        return NuevoUsuario(_escritura, _sucursales);
    }) : yo(_templateObject5), cajas.map(function (u) {
        return yo(_templateObject6, u.Cod_Caja, u.Des_Caja, u.Cod_Sucursal, u.Cod_UsuarioCajero, u.Cod_CuentaContable, _escritura ? yo(_templateObject7) : yo(_templateObject5), _escritura ? yo(_templateObject8) : yo(_templateObject5));
...
function ListarCajas(escritura) {
    ...
    fetch('/cajas_api/get_cajas', parametros).then(function (req) {
        return req.json();
    }).then(function (res) {
        if (res.respuesta == 'ok') {
...
},{"../navegador":345,"empty-element":330,"page":338,"title":339,"yo-yo":340}],344:[function(require,module,exports){
'use strict';
...
},{"../cajas/listar":342,"../usuarios/listar":347,"empty-element":330,"yo-yo":340}],346:[function(require,module,exports){
'use strict';
...
},{"./listar":347,"empty-element":330,"yo-yo":340}],347:[function(require,module,exports){
'use strict';
